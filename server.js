...
'7. אם אין עסקה - צור עסקה חדשה עם כל השדות הנדרשים:\n' +
'   - שם העסקה: "[שם לקוח] - [שם פרויקט]"\n' +
'   - כל השדות החובה (ראה למטה)\n' +
'8. עדכן סטטוס לקוח ל"לקוח בתהליך" (update_record)\n' +
'9. הודע: "✅ נוצרה עסקה חדשה! מספר: [ID]. סטטוס הלקוח עודכן."\n\n' +
...
'1. אם יש שם + טלפון/אימייל - צור מיד!\n' +
'2. אם יש רק שם - בקש: "מה מספר הטלפון של [שם]?"\n' +
'3. אחרי שקיבלת טלפון - בקש: "ומה האימייל?"\n' +
'4. אחרי שיש שם + טלפון + אימייל - צור את הלקוח!\n' +
'5. אל תבקש כתובת, גודל משרד, הערות - אלה אופציונליים\n' +
'6. בקש פרט אחד בכל פעם - לא רשימה!\n\n' +
