...
// SystemPrompt חכם עם בדיקת שדות דינמית
const systemPrompt = 'אתה עוזר חכם שמחובר לאיירטיבל.\n\n' +
    ...
    '⚡ דוגמה לזרימה חכמה:\n' +
    'בקשה: "עדכן את גודל המשרד של דונלד בעסקה"\n' +
    '1. search_airtable כדי למצוא את דונלד\n' +
    '2. get_table_fields עבור טבלת עסקאות לראות איך קוראים לשדה\n' +
    '3. update_record עם השם המדויק של השדה\n\n' +
